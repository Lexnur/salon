...
class Products(models.Model):
    ...
    brand = models.CharField(max_length=150, blank=True, null=True, verbose_name='Производитель')
    series = models.CharField(max_length=150, blank=True, null=True, verbose_name='Серия')
    volume = models.PositiveSmallIntegerField(null=True, blank=True, verbose_name='Объем')
